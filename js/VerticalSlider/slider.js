var Slider = (function() {
	...
	var $container = $( '#ps-container' ),
		...
		initEvents = function() {
            ...
            $navprev2.on( 'click', function( event ) {
				if( !isAnimating ) {
            ...
            $navnext2.on( 'click', function( event ) {
				if( !isAnimating ) {
		...
		slide = function( dir ) {
			...
			setTimeout( function() {
                ...
                //$currentSlide.removeClass('container-fluid center-content slide');

				// move the new ones to the main viewport
                //var moveTo = screenSize > 860 ? 205 : 0;
